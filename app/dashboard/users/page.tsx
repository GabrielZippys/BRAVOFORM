                    ...
                    {modalContent === 'company' && (
                        <div className={modalStyles.panelBody}>
                            <div className={modalStyles.formGroup}>
                                ...
                                <input value={formState.companyName} onChange={e => setFormState({...formState, companyName: e.target.value})} className={modalStyles.input} required />
                            </div>
                        </div>
                    )}
                    {modalContent === 'department' && (
                        <div className={modalStyles.panelBody}>
                            <div className={modalStyles.formGroup}>
                                ...
                                <input value={formState.departmentName} onChange={e => setFormState({...formState, departmentName: e.target.value})} className={modalStyles.input} required />
                            </div>
                        </div>
                    )}
                        ...
                        <div className={modalStyles.panelBody}>
                            <div className={modalStyles.form}>
                                <div className={modalStyles.formGroup}>
                                    ...
                                    <input value={formState.userName} onChange={e => setFormState({...formState, userName: e.target.value})} className={modalStyles.input} required />
                                </div>
                                <div className={modalStyles.formGroup}>
                                    <label className={modalStyles.label}>Email de Acesso</label>
                                    <input type="email" value={formState.userEmail} onChange={e => setFormState({...formState, userEmail: e.target.value})} className={modalStyles.input} disabled={modalMode === 'edit'} required />
                                </div>
                                {modalMode === 'create' && (
                                    <>
                                        <div className={modalStyles.formGroup}>
                                            <label className={modalStyles.label}>Senha</label>
                                            <input type={showPassword ? 'text' : 'password'} value={formState.userPassword} onChange={e => setFormState({...formState, userPassword: e.target.value})} className={modalStyles.input} required />
                                        </div>
                                        <div className={modalStyles.formGroup}>
                                            <label className={modalStyles.label}>Confirmar Senha</label>
                                            <input type={showPassword ? 'text' : 'password'} value={formState.userPasswordConfirm} onChange={e => setFormState({...formState, userPasswordConfirm: e.target.value})} className={modalStyles.input} required />
                                        </div>
                                    </>
                                )}
                                {modalContent === 'user' && (
                                    <div className={modalStyles.formGroup}>
                                        ...
                                        <select value={formState.userRole} onChange={e => setFormState({...formState, userRole: e.target.value as UserRole})} className={modalStyles.input}>
